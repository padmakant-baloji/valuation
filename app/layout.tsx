...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Professional property valuation, real estate valuation, land rate assessment, site rate evaluation, and technical reports in Karnataka. IBBI Registered Valuer in Belagavi. Bank-approved property valuation services. Trusted by 30+ Banks & Financial Institutions.',
    images: [
      {
        url: '/logo.png',
        width: 1200,
